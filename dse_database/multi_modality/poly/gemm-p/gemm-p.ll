...
define dso_local void @kernel_gemm(i32 %ni, i32 %nj, i32 %nk, double %alpha, double %beta, [70 x double]* %C, [80 x double]* %A, [70 x double]* %B) #0 !dbg !7 {
entry:
  ...
  call void @llvm.dbg.declare(metadata [70 x double]** %C.addr, metadata !30, metadata !DIExpression()), !dbg !31
  store [80 x double]* %A, [80 x double]** %A.addr, align 8
  call void @llvm.dbg.declare(metadata [80 x double]** %A.addr, metadata !32, metadata !DIExpression()), !dbg !33
  store [70 x double]* %B, [70 x double]** %B.addr, align 8
  call void @llvm.dbg.declare(metadata [70 x double]** %B.addr, metadata !34, metadata !DIExpression()), !dbg !35
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %1, 70, !dbg !55
  br i1 %cmp2, label %for.body3, label %for.end, !dbg !56

for.body3:                                        ; preds = %for.cond1
  %2 = load double, double* %beta.addr, align 8, !dbg !57
  %3 = load [70 x double]*, [70 x double]** %C.addr, align 8, !dbg !59
  %4 = load i32, i32* %i, align 4, !dbg !60
  %idxprom = sext i32 %4 to i64, !dbg !59
  %arrayidx = getelementptr inbounds [70 x double], [70 x double]* %3, i64 %idxprom, !dbg !59
  %5 = load i32, i32* %j, align 4, !dbg !61
  %idxprom4 = sext i32 %5 to i64, !dbg !59
  %arrayidx5 = getelementptr inbounds [70 x double], [70 x double]* %arrayidx, i64 0, i64 %idxprom4, !dbg !59
...
for.cond9:                                        ; preds = %for.inc26, %for.body8
  ...
  %cmp10 = icmp slt i32 %9, 70, !dbg !82
  br i1 %cmp10, label %for.body11, label %for.end28, !dbg !83

for.body11:                                       ; preds = %for.cond9
  %10 = load double, double* %alpha.addr, align 8, !dbg !84
  %11 = load [80 x double]*, [80 x double]** %A.addr, align 8, !dbg !86
  %12 = load i32, i32* %i, align 4, !dbg !87
  %idxprom12 = sext i32 %12 to i64, !dbg !86
  %arrayidx13 = getelementptr inbounds [80 x double], [80 x double]* %11, i64 %idxprom12, !dbg !86
  %13 = load i32, i32* %k, align 4, !dbg !88
  %idxprom14 = sext i32 %13 to i64, !dbg !86
  %arrayidx15 = getelementptr inbounds [80 x double], [80 x double]* %arrayidx13, i64 0, i64 %idxprom14, !dbg !86
  %14 = load double, double* %arrayidx15, align 8, !dbg !86
  %mul16 = fmul double %10, %14, !dbg !89
  %15 = load [70 x double]*, [70 x double]** %B.addr, align 8, !dbg !90
  %16 = load i32, i32* %k, align 4, !dbg !91
  %idxprom17 = sext i32 %16 to i64, !dbg !90
  %arrayidx18 = getelementptr inbounds [70 x double], [70 x double]* %15, i64 %idxprom17, !dbg !90
  %17 = load i32, i32* %j, align 4, !dbg !92
  %idxprom19 = sext i32 %17 to i64, !dbg !90
  %arrayidx20 = getelementptr inbounds [70 x double], [70 x double]* %arrayidx18, i64 0, i64 %idxprom19, !dbg !90
  %18 = load double, double* %arrayidx20, align 8, !dbg !90
  %mul21 = fmul double %mul16, %18, !dbg !93
  %19 = load [70 x double]*, [70 x double]** %C.addr, align 8, !dbg !94
  %20 = load i32, i32* %i, align 4, !dbg !95
  %idxprom22 = sext i32 %20 to i64, !dbg !94
  %arrayidx23 = getelementptr inbounds [70 x double], [70 x double]* %19, i64 %idxprom22, !dbg !94
  %21 = load i32, i32* %j, align 4, !dbg !96
  %idxprom24 = sext i32 %21 to i64, !dbg !94
  %arrayidx25 = getelementptr inbounds [70 x double], [70 x double]* %arrayidx23, i64 0, i64 %idxprom24, !dbg !94
...
!1 = !DIFile(filename: "gemm-p.c", directory: "/share/atefehSZ/RL/original-software-gnn/software-gnn/dse_database/multi_modality/poly/gemm-p")
!2 = !{}
...
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !11, size: 4480, elements: !14)
!14 = !{!15}
!15 = !DISubrange(count: 70)
!16 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !17, size: 64)
!17 = !DICompositeType(tag: DW_TAG_array_type, baseType: !11, size: 5120, elements: !18)
!18 = !{!19}
!19 = !DISubrange(count: 80)
...
!33 = !DILocation(line: 3, column: 88, scope: !7)
!34 = !DILocalVariable(name: "B", arg: 8, scope: !7, file: !1, line: 3, type: !12)
!35 = !DILocation(line: 3, column: 105, scope: !7)
...
!42 = !DILocation(line: 23, column: 10, scope: !43)
!43 = distinct !DILexicalBlock(scope: !7, file: !1, line: 23, column: 3)
!44 = !DILocation(line: 23, column: 8, scope: !43)
!45 = !DILocation(line: 23, column: 15, scope: !46)
!46 = distinct !DILexicalBlock(scope: !43, file: !1, line: 23, column: 3)
!47 = !DILocation(line: 23, column: 17, scope: !46)
!48 = !DILocation(line: 23, column: 3, scope: !43)
!49 = !DILocation(line: 26, column: 12, scope: !50)
!50 = distinct !DILexicalBlock(scope: !51, file: !1, line: 26, column: 5)
!51 = distinct !DILexicalBlock(scope: !46, file: !1, line: 23, column: 28)
!52 = !DILocation(line: 26, column: 10, scope: !50)
!53 = !DILocation(line: 26, column: 17, scope: !54)
!54 = distinct !DILexicalBlock(scope: !50, file: !1, line: 26, column: 5)
!55 = !DILocation(line: 26, column: 19, scope: !54)
!56 = !DILocation(line: 26, column: 5, scope: !50)
!57 = !DILocation(line: 27, column: 18, scope: !58)
!58 = distinct !DILexicalBlock(scope: !54, file: !1, line: 26, column: 30)
!59 = !DILocation(line: 27, column: 7, scope: !58)
!60 = !DILocation(line: 27, column: 9, scope: !58)
!61 = !DILocation(line: 27, column: 12, scope: !58)
!62 = !DILocation(line: 27, column: 15, scope: !58)
!63 = !DILocation(line: 28, column: 5, scope: !58)
!64 = !DILocation(line: 26, column: 26, scope: !54)
!65 = !DILocation(line: 26, column: 5, scope: !54)
!66 = distinct !{!66, !56, !67, !68}
!67 = !DILocation(line: 28, column: 5, scope: !50)
!68 = !{!"llvm.loop.mustprogress"}
!69 = !DILocation(line: 35, column: 12, scope: !70)
!70 = distinct !DILexicalBlock(scope: !51, file: !1, line: 35, column: 5)
!71 = !DILocation(line: 35, column: 10, scope: !70)
!72 = !DILocation(line: 35, column: 17, scope: !73)
!73 = distinct !DILexicalBlock(scope: !70, file: !1, line: 35, column: 5)
!74 = !DILocation(line: 35, column: 19, scope: !73)
!75 = !DILocation(line: 35, column: 5, scope: !70)
!76 = !DILocation(line: 38, column: 14, scope: !77)
!77 = distinct !DILexicalBlock(scope: !78, file: !1, line: 38, column: 7)
!78 = distinct !DILexicalBlock(scope: !73, file: !1, line: 35, column: 30)
!79 = !DILocation(line: 38, column: 12, scope: !77)
!80 = !DILocation(line: 38, column: 19, scope: !81)
!81 = distinct !DILexicalBlock(scope: !77, file: !1, line: 38, column: 7)
!82 = !DILocation(line: 38, column: 21, scope: !81)
!83 = !DILocation(line: 38, column: 7, scope: !77)
!84 = !DILocation(line: 39, column: 20, scope: !85)
!85 = distinct !DILexicalBlock(scope: !81, file: !1, line: 38, column: 32)
!86 = !DILocation(line: 39, column: 28, scope: !85)
!87 = !DILocation(line: 39, column: 30, scope: !85)
!88 = !DILocation(line: 39, column: 33, scope: !85)
!89 = !DILocation(line: 39, column: 26, scope: !85)
!90 = !DILocation(line: 39, column: 38, scope: !85)
!91 = !DILocation(line: 39, column: 40, scope: !85)
!92 = !DILocation(line: 39, column: 43, scope: !85)
!93 = !DILocation(line: 39, column: 36, scope: !85)
!94 = !DILocation(line: 39, column: 9, scope: !85)
!95 = !DILocation(line: 39, column: 11, scope: !85)
!96 = !DILocation(line: 39, column: 14, scope: !85)
!97 = !DILocation(line: 39, column: 17, scope: !85)
!98 = !DILocation(line: 40, column: 7, scope: !85)
!99 = !DILocation(line: 38, column: 28, scope: !81)
!100 = !DILocation(line: 38, column: 7, scope: !81)
!101 = distinct !{!101, !83, !102, !68}
!102 = !DILocation(line: 40, column: 7, scope: !77)
!103 = !DILocation(line: 41, column: 5, scope: !78)
!104 = !DILocation(line: 35, column: 26, scope: !73)
!105 = !DILocation(line: 35, column: 5, scope: !73)
!106 = distinct !{!106, !75, !107, !68}
!107 = !DILocation(line: 41, column: 5, scope: !70)
!108 = !DILocation(line: 42, column: 3, scope: !51)
!109 = !DILocation(line: 23, column: 24, scope: !46)
!110 = !DILocation(line: 23, column: 3, scope: !46)
!111 = distinct !{!111, !48, !112, !68}
!112 = !DILocation(line: 42, column: 3, scope: !43)
!113 = !DILocation(line: 45, column: 1, scope: !7)
