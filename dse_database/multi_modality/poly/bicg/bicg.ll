...
define dso_local void @kernel_bicg(i32 %m, i32 %n, [116 x double]* %A, double* %s, double* %q, double* %p, double* %r) #0 !dbg !9 {
entry:
  ...
  call void @llvm.dbg.declare(metadata [116 x double]** %A.addr, metadata !22, metadata !DIExpression()), !dbg !23
...
for.cond1:                                        ; preds = %for.inc30, %for.end
  ...
  %cmp2 = icmp slt i32 %4, 124, !dbg !58
...
for.cond6:                                        ; preds = %for.inc27, %for.body3
  ...
  %cmp7 = icmp slt i32 %7, 116, !dbg !69
...
for.body8:                                        ; preds = %for.cond6
  ...
  %11 = load [116 x double]*, [116 x double]** %A.addr, align 8, !dbg !74
  %12 = load i32, i32* %i, align 4, !dbg !75
  %idxprom11 = sext i32 %12 to i64, !dbg !74
  %arrayidx12 = getelementptr inbounds [116 x double], [116 x double]* %11, i64 %idxprom11, !dbg !74
  %13 = load i32, i32* %j, align 4, !dbg !76
  %idxprom13 = sext i32 %13 to i64, !dbg !74
  %arrayidx14 = getelementptr inbounds [116 x double], [116 x double]* %arrayidx12, i64 0, i64 %idxprom13, !dbg !74
  ...
  %18 = load [116 x double]*, [116 x double]** %A.addr, align 8, !dbg !81
  %19 = load i32, i32* %i, align 4, !dbg !82
  %idxprom17 = sext i32 %19 to i64, !dbg !81
  %arrayidx18 = getelementptr inbounds [116 x double], [116 x double]* %18, i64 %idxprom17, !dbg !81
  %20 = load i32, i32* %j, align 4, !dbg !83
  %idxprom19 = sext i32 %20 to i64, !dbg !81
  %arrayidx20 = getelementptr inbounds [116 x double], [116 x double]* %arrayidx18, i64 0, i64 %idxprom19, !dbg !81
...
!1 = !DIFile(filename: "bicg.c", directory: "/share/atefehSZ/RL/original-software-gnn/software-gnn/dse_database/multi_modality/poly/bicg")
!2 = !{}
!3 = !{!4}
...
!14 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 7424, elements: !15)
!15 = !{!16}
!16 = !DISubrange(count: 116)
...
!41 = !DILocation(line: 10, column: 17, scope: !40)
!42 = !DILocation(line: 10, column: 3, scope: !37)
!43 = !DILocation(line: 11, column: 5, scope: !44)
!44 = distinct !DILexicalBlock(scope: !40, file: !1, line: 10, column: 29)
!45 = !DILocation(line: 11, column: 7, scope: !44)
!46 = !DILocation(line: 11, column: 10, scope: !44)
!47 = !DILocation(line: 12, column: 3, scope: !44)
!48 = !DILocation(line: 10, column: 25, scope: !40)
!49 = !DILocation(line: 10, column: 3, scope: !40)
!50 = distinct !{!50, !42, !51, !52}
!51 = !DILocation(line: 12, column: 3, scope: !37)
!52 = !{!"llvm.loop.mustprogress"}
!53 = !DILocation(line: 19, column: 10, scope: !54)
!54 = distinct !DILexicalBlock(scope: !9, file: !1, line: 19, column: 3)
!55 = !DILocation(line: 19, column: 8, scope: !54)
!56 = !DILocation(line: 19, column: 15, scope: !57)
!57 = distinct !DILexicalBlock(scope: !54, file: !1, line: 19, column: 3)
!58 = !DILocation(line: 19, column: 17, scope: !57)
!59 = !DILocation(line: 19, column: 3, scope: !54)
!60 = !DILocation(line: 20, column: 5, scope: !61)
!61 = distinct !DILexicalBlock(scope: !57, file: !1, line: 19, column: 29)
!62 = !DILocation(line: 20, column: 7, scope: !61)
...
!66 = !DILocation(line: 23, column: 10, scope: !65)
!67 = !DILocation(line: 23, column: 17, scope: !68)
!68 = distinct !DILexicalBlock(scope: !65, file: !1, line: 23, column: 5)
!69 = !DILocation(line: 23, column: 19, scope: !68)
!70 = !DILocation(line: 23, column: 5, scope: !65)
!71 = !DILocation(line: 24, column: 15, scope: !72)
!72 = distinct !DILexicalBlock(scope: !68, file: !1, line: 23, column: 31)
!73 = !DILocation(line: 24, column: 17, scope: !72)
!74 = !DILocation(line: 24, column: 22, scope: !72)
!75 = !DILocation(line: 24, column: 24, scope: !72)
!76 = !DILocation(line: 24, column: 27, scope: !72)
!77 = !DILocation(line: 24, column: 20, scope: !72)
!78 = !DILocation(line: 24, column: 7, scope: !72)
!79 = !DILocation(line: 24, column: 9, scope: !72)
!80 = !DILocation(line: 24, column: 12, scope: !72)
!81 = !DILocation(line: 25, column: 15, scope: !72)
!82 = !DILocation(line: 25, column: 17, scope: !72)
!83 = !DILocation(line: 25, column: 20, scope: !72)
!84 = !DILocation(line: 25, column: 25, scope: !72)
!85 = !DILocation(line: 25, column: 27, scope: !72)
!86 = !DILocation(line: 25, column: 23, scope: !72)
!87 = !DILocation(line: 25, column: 7, scope: !72)
!88 = !DILocation(line: 25, column: 9, scope: !72)
!89 = !DILocation(line: 25, column: 12, scope: !72)
!90 = !DILocation(line: 26, column: 5, scope: !72)
!91 = !DILocation(line: 23, column: 27, scope: !68)
!92 = !DILocation(line: 23, column: 5, scope: !68)
!93 = distinct !{!93, !70, !94, !52}
!94 = !DILocation(line: 26, column: 5, scope: !65)
!95 = !DILocation(line: 27, column: 3, scope: !61)
!96 = !DILocation(line: 19, column: 25, scope: !57)
!97 = !DILocation(line: 19, column: 3, scope: !57)
!98 = distinct !{!98, !59, !99, !52}
!99 = !DILocation(line: 27, column: 3, scope: !54)
!100 = !DILocation(line: 29, column: 1, scope: !9)
